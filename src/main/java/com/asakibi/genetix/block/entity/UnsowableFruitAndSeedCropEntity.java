...
public abstract class UnsowableFruitAndSeedCropEntity extends FruitAndSeedsCropEntity {
    public UnsowableFruitAndSeedCropEntity(BlockEntityType<?> type, BlockPos pos, BlockState state, DiploidStructure diploidStructure) {
